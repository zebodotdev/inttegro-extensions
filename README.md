...
Official downloads for the Inttegro plugins that connect WordPress and WooCommerce to Inttegro.
...
Every release includes SHA-256 checksums. The plugin packages contain their human-readable PHP and JavaScript source and are licensed GPL-2.0-or-later.

For security issues, contact support@inttegro.com instead of opening a public issue.
